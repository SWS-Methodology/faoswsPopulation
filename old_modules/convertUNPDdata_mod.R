...
pop_tot_pop_WPP2017_melt= melt(pop_tot_pop_WPP2017, id.vars = c("Variant","Country_code"),
...
pop_tot_pop_WPP2017_MediumVariantFertility=fread(file.path(getwd(),"population/total/WPP2019_TOTAL_POPULATION_MVF.csv"),
                                                 header = TRUE)
##melt data
pop_tot_pop_WPP2017_MVF_melt= melt(pop_tot_pop_WPP2017_MediumVariantFertility, id.vars = c("Variant","Country_code"),
                                   variable.name= "timePointYears",
                                   value.name = "Value")
...
WPP2017_POP_FEMALE_melt= melt(WPP2017_POP_FEMALE, id.vars = c("Variant","Country_code"),
                              variable.name= "timePointYears",
                              value.name = "Value")
...
WPP2017_POP_MVF_FEMALE= fread(file.path(getwd(),"population/female/WPP2019_POP_FEMALE_MVF.csv"),
                             header = TRUE)
##melt data
WPP2017_POP_MVF_FEMALE_melt= melt(WPP2017_POP_MVF_FEMALE, id.vars = c("Variant","Country_code"),
                                  variable.name= "timePointYears",
                                  value.name = "Value")
...
WPP2017_POP_MALE_melt= melt(WPP2017_POP_MALE, id.vars = c("Variant","Country_code"),
                            variable.name= "timePointYears",
                            value.name = "Value")
...
WPP2017_POP_MVF_MALE=fread(file.path(getwd(),"population/male/WPP2019_POP_MALE_MVF.csv"),
                           header = TRUE)
##melt data
WPP2017_POP_MVF_MALE_melt= melt(WPP2017_POP_MVF_MALE, id.vars = c("Variant","Country_code"),
                                variable.name= "timePointYears",
                                value.name = "Value")
...
finalFileLabel=nameData("population","population_unpd",finalSWS)
