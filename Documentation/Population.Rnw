...
\item{builds the \code{SWS} metadata file. Please specify in the routine the version of both the WPP and WUP (line 1-2), For example at the moment we have \textit{"WPP2017"} and \textit{"WUP2014"};}
